...
- Minor: gives a light generic "open network settings -> change DNS -> save" (slightly beyond the literal KB, but intentionally allowed by the "simplify steps" rule). Echoing "E-204" is fine - the customer reported it.
